...
- **Images read as one line.** A grid cell or filmstrip frame reads its file name, flag, stars and whether it is edited, as in "DSC_0107.NEF, picked, 3 stars, edited". Filmstrip frames can be pressed to open them.
