...
- **The only merge options are Auto Align, Deghost and Auto Settings,** and a reference photo you pick lasts for that merge only (HDR Merge Without Dialog always chooses it automatically).
