...
/// it's display plumbing. The pipeline produces a correct image at some
/// resolution; this fits that image into whatever shape the window
/// currently is.
///
...
/// white survive to the screen. That's a deliberate later change, not an
/// oversight — see the notes in DESIGN.md.
public final class Presenter {
    ...
    /// Draws `texture` into `drawable`, fitted and letterboxed.
